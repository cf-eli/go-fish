 ...
 * @author Alex
 */
public class DeprAskResult extends javax.swing.JFrame {
    ...
    String cardUrl;
    String answer;
    public DeprAskResult(String ask, String player, String url, String ans) {
        initComponents();
        asked = ask;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeprAskResult.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
