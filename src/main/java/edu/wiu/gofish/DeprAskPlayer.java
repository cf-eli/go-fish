 ...
 * @author Alex
 */
public class DeprAskPlayer extends javax.swing.JFrame {
    ...
    public DeprAskPlayer(ArrayList<String> players) {//show error if player attempt to pick the wrong option
        initComponents();
        cPlayers = players;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeprAskPlayer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
