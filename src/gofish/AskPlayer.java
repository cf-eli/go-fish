 ...
 * @author Alex
 */
public class AskPlayer extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AskPlayer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
